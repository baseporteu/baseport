...
// pushing a backup to S3-compatible storage: whether it should run at all, the key it lands under, and that a
// failed upload never touches the caller's already-successful local snapshot
